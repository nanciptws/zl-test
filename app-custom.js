if ($(window).width() <= 767) {
    $(".footer-links .link-title").click(function () {
  ...
  if ($(window).width() <= 991) {
    ...
    $(".header-main .menu-products > a").click(function () {
      $(this).parent().toggleClass("active");
  ...
  //faq
  $(".faq_cms_section .acc_head").click(function () {
    $(this).toggleClass("active").next(".acc_content").slideToggle(300);
  });
  
  $(".wrc_cms_section .acc_head").click(function () {
    $(this).toggleClass("active").next(".acc_content").slideToggle(300);
  });
  ...
  function jot_form_iFrame_height() {
    ...
    var JotFormIFrame_id = $(".JotFormIFrame").attr("id");
  ...
  if ($(window).width() >= 992) {
    $(".top-menu .menu-products > a").click(function(){
        $(".top-menu > li .sub-menu .menu-list").toggle();
      });
